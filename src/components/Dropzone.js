...
export default function Dropzone({closeTab}) {
  ...
  return (
    ...
    <div className="flex w-[100%] h-12 border-2 border-b-0 border-slate-400 flex-row-reverse bg-[#181F3C] ">
            ...
            <div onClick={()=>{closeTab(false)}} className=" absolute left-[2px] top-2  cursor-pointer" id="close_ipload">
    ...
    <div className="max-w-7xl shadow-xl mx-auto flex">
        ...
        <div className="bg-white  shadow-sm sm:rounded-lg w-[100%] h-64 justify-center b items-center ">
            <div  {...getRootProps({className: 'dropzone'})} className="dropzone min-h-full"  id="dropzone">
                    ...
                    <aside className="float-right mr-3 mt-6">
                        <h4 className="text-right font-Cairo text-lg"> الملف</h4>
